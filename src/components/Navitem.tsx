...
const  NavItem = ({category,handleOpen,isAnyOpen,isOpen}:NavItemsProps) =>{
   return <div className="flex">
    ...
    <Button className="gap-1.5 " onClick={handleOpen} variant={isOpen ? "default" : "ghost" }>
      {category.label}
    ...
    {isOpen ? (
      <div className={cn("absolute inset-x-0 top-full text-sm text-muted-foreground", {"animated-in fade-in-10 slide-in-from-top-5" : !isAnyOpen})}>
