        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    // Await the payload.init() call before assigning it to cached.promise
                    _c = cached;
                    return [4 /*yield*/, payload_1.default.init(__assign({ email: { transport: transpoter, fromAddress: "onboarding@resend.dev", fromName: "DigitalWhale" }, secret: process.env.PAYLOAD_SECRET, local: (initOptions === null || initOptions === void 0 ? void 0 : initOptions.express) ? false : true }, (initOptions || {})))];
                case 1:
                    // Await the payload.init() call before assigning it to cached.promise
                    _c.promise = _e.sent();
                    _e.label = 2;
